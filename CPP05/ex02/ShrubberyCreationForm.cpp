...
#include <fstream>
ShrubberyCreationForm::ShrubberyCreationForm(): Form("SCF", 25, 5), target("SCF"){}
ShrubberyCreationForm::ShrubberyCreationForm(std:: string target): Form("SCF", 25, 5), target(target){}
